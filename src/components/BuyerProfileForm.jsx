      ...
      <div className="max-w-3xl mx-auto py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="glass p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-8">
            ...
            <div className="field-group">
              <label className="form-label mb-2 block">Buyer Type</label>
              <div className="relative">
                <select
                  name="buyer_type"
                  className="form-input pl-11 appearance-auto cursor-pointer"
                ...
                <TrendingUp className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none" size={18} />
              </div>
            </div>

            {/* Organization Description */}
            <div className="field-group">
              <label className="form-label mb-2 block">Organization Description</label>
              <div className="relative">
                <textarea
