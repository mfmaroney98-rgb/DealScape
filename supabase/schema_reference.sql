...
CREATE TABLE public.buyer_criteria (
  ...
  search_enterprise_value_min numeric,
  search_enterprise_value_max numeric,
  search_equity_value_min numeric,
  search_equity_value_max numeric,
...
CREATE TABLE public.organizations (
  ...
  headquarters text,
  other_locations ARRAY DEFAULT '{}'::text[],
